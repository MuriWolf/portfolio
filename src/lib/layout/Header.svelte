...
<header class="flex justify-between items-center">
    ...
    <nav class="ml-auto hidden min-[980px]:block">
        <ul class="flex gap-x-8 list-decimal text-c-body-text text-lg">
            <li class="hover:text-c-tertiary transition-all"><a href="#hero">Intro</a></li>
            <li class="hover:text-c-tertiary transition-all"><a href="#about">About</a></li>
            <li class="hover:text-c-tertiary transition-all"><a href="#technologies">Techs</a></li>
            <li class="hover:text-c-tertiary transition-all"><a href="#projects">Projects</a></li>
            <li class="hover:text-c-tertiary transition-all"><a href="#testimonials">Testimonials</a></li>
            <li class="hover:text-c-tertiary transition-all"><a href="#contact">Contact</a></li>
        </ul>
    </nav>
    <button class="ml-4 hidden min-[980px]:block text-white hover:text-c-tertiary transition-all">
