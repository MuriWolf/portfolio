...
<header class="flex justify-between items-center">
	...
	<DropdownMenu.Root>
		<DropdownMenu.Trigger>
			<button
				class="ml-4 hidden min-[980px]:block text-white hover:text-black transition-all duration-200 ease-in"
			>
				<svg
			...
			<DropdownMenu.Group>
				<form method="POST" bind:this={languageSwitcherForm} use:enhance={submitNewLanguage}>
					...
					<button
						...
						class="flex gap-x-2 items-center hover:bg-gray-100 p-3 transition-all duration-150 hover:cursor-pointer font-semibold w-full"
					>
						<img src="images/flags/us.svg" width="32" alt="United States of America flag" />
						<p>English</p>
					</button>
				</form>
			</DropdownMenu.Group>
