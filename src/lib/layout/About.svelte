...
<section id="about" class="max-[956px]:col-span-2 relative flex justify-between gradient-dark-one py-12 px-4 xs:px-6 sm:px-8 rounded-3xl gap-4 bg-test">
    ...
    <div class="sm:flex-1 hidden sm:block">
        <img src="/images/photos/me2.png" width="240" height="240" draggable="false" class="max-[660px]:w-40 max-[660px]:h-40 max-[956px]:w-60 max-[956px]:h-60 w-40 h-40 lg:w-48 lg:h-48 xl:w-60 xl:h-60 ml-auto border-4 rounded-2xl border-c-secondary shadow-2xl select-none"  alt="onwner of the website">
    </div>
