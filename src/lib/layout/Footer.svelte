...
<!-- <Saos animation={"slide-top 0.4s cubic-bezier(0.645, 0.045, 0.355, 1.000) both"} top={50} bottom={50} > -->
    <footer class="max-w-[1340px] mx-auto">
        <div class="flex-col relative text-center gradient-blue-ish border-2 border-white/70 mx-4 xs:mx-8 py-10 px-8 lg:px-16 rounded-2xl flex justify-center mb-4 xs:mb-8 ">
