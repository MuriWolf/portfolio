...
<footer class="max-w-[1340px] mx-auto">
	...
	>
		<img
			src={logo}
			alt="logo"
			class="max-sm:mb-4 sm:absolute sm:left-1/2 sm:-translate-x-[275%] mx-auto max-w-[82px] max-h-[82px]"
		/>
		<p class="text-c-body-text font-semibold">
			{$textContent.footer.authorship[$languageSelected]}
		</p>
		<Tooltip.Root openDelay={300}>
			...
			<Tooltip.Content>
				<p class="font-semibold bg-opacity-0 shadow-none">
					{$textContent.footer.love[$languageSelected]}
				</p>
			</Tooltip.Content>
		</Tooltip.Root>
