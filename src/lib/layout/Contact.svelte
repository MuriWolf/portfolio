...
<Saos on:update={handleUpdateSectionView} top={200} bottom={0}>
    <section id="contact" class="col-span-2 bg-c-background bg-test rounded-3xl py-12 px-4 xs:px-6 sm:px-8  gradient-dark-one overflow-x-hidden" >
        ...
        <div class="relative max-w-4xl mx-auto mt-8 md:mt-24 flex max-md:flex-col-reverse gap-8 ">
            <div class="md:hidden relative z-10 bg-c-primary rounded-xl shadow-claymorphism p-6 border-b-8 border-b-c-secondary">
            ...
            <form method="POST" action="?/submitForm" class="relative z-10 flex flex-col gap-y-6 py-6 px-4 xs:px-6 bg-gray-300 bg-opacity-0 rounded-xl flex-[7] gradient-form backdrop-blur-3xl glass-border">
                {#if $textContent}
            ...
            <div class="relative z-10 flex flex-col gap-y-7 flex-[5]">
                <div class="bg-c-primary rounded-xl shadow-claymorphism p-6 border-b-8 border-b-c-secondary bg-test2 mt-auto relative transition-all perspective-400 ease-[cubic-bezier(0.645,0.045,0.355,1.000)] duration-2000 {showingSection ? 'translate-x-0' : 'translate-x-3 -translate-z-12'}">
                ...
                <div class="max-md:hidden bg-c-primary rounded-xl shadow-claymorphism p-6 border-b-8 border-b-c-secondary">
