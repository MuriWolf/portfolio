...
<Saos on:update={handleUpdateSectionView} top={200} bottom={0}>
    <section id="contact" class="col-span-2 bg-black rounded-3xl py-12 px-4 xs:px-6 sm:px-8  gradient-dark-one overflow-x-hidden" >
        <h2 class="font-title font-bold text-2xl xs:text-3xl text-c-body-text mb-6 lowercase">5. {$textContent.contact.title[$languageSelected] ?? "CONTACT"}</h2>
        <div class="relative max-w-4xl mx-auto mt-8 md:mt-24 flex max-md:flex-col-reverse gap-8 ">
            <div class="md:hidden relative z-10 bg-white rounded-xl p-6">
            ...
            <form method="POST" action="?/submitForm" class="relative z-10 flex flex-col gap-y-6 py-6 px-4 xs:px-6 bg-gray-300 bg-opacity-0 rounded-xl flex-[7] gradient-form backdrop-blur-3xl ">
                {#if $textContent}
                    ...
                    <Button type="submit" class="bg-black flex-1 w-full min-w-full block text-white font-title font-bold text-lg xs:text-xl rounded-[5px]  shadow-[#000000bb] active:bg-c-tertiary hover:bg-c-tertiary hover:brightness-90 active:scale-90 transition-all ">{$textContent.contact.form.submitButton[$languageSelected]}</Button>
                {/if}
            </form>
            ...
            <img src={colorExplosion} alt="" class="absolute z-0 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 scale-[1.2]">
                ...
                <div class="max-md:hidden bg-white rounded-xl p-6 ">
                    ...
                    <nav class="max-w-lg mx-auto text-gray-200">
                        <ul class="flex gap-x-4 justify-center mt-5 mb-2">
                            ...
                            <li class="hover:text-black text-stone-600 transition-all duration-200 ease-in">
                                <a href="https://www.linkedin.com/in/murillo-pinheiro-de-oliveira-2b931724a/" target="_blank" rel="author"><LinkedinIcon /></a>
                            </li>
                            <li class="hover:text-black text-stone-600 transition-all duration-200 ease-in">
                                <a href="https://web.telegram.org/k/#@MuriWolf" target="_blank" rel="author"><TelegramIcon /></a>
                            </li>
                            <li class="hover:text-black text-stone-600 transition-all duration-200 ease-in">
                                <a href="https://www.reddit.com/user/MuriWolf/" target="_blank" rel="author"><RedditIcon /></a>
                            </li>
                        </ul>
                    </nav>
                </div>
