...
<section id="contact" class="col-span-2 bg-c-background bg-test rounded-3xl py-12 px-4 xs:px-6 sm:px-8  gradient-dark-one overflow-x-hidden" >
    ...
    <div class="relative max-w-4xl mx-auto mt-8 md:mt-24 flex max-md:flex-col-reverse gap-8">
        ...
        <form action="" class="relative z-10 flex flex-col gap-y-6 py-6 px-4 xs:px-6 bg-gray-300 bg-opacity-0 rounded-3xl flex-[7] gradient-form backdrop-blur-3xl glass-border">
            ...
            <Button type="submit" class="bg-gradient-to-b from-c-tertiary to-[#B5F186] flex-1 w-full min-w-full block text-c-darker-background font-title font-bold text-lg xs:text-xl rounded-xl text-shadow shadow-[#000000bb] active:bg-c-tertiary hover:bg-c-tertiary hover:brightness-90 active:scale-90 transition-all shadow-claymorphism-2">Shoot a Message </Button>
        </form>
        ...
        <div class="relative z-10 flex flex-col gap-y-7 flex-[5]">
            ...
            <div class="bg-c-primary rounded-3xl shadow-claymorphism p-6 border-b-8 border-b-c-secondary bg-test2">
