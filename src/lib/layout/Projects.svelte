            ...
            {#if projects}
                {#each projects as project (project.id)}
                    <Carousel.Item class="basis-[92%] lg:basis-1/2 flex flex-col gap-5">
                        <AspectRatio ratio={16 / 9} class="z-10 bg-gray-300 shadow-xl bg-opacity-0 relative rounded-xl overflow-hidden">
                            <img
                        ...
                        <div class="flex flex-wrap justify-between gap-y-6 p-4 rounded-xl gradient-form border-[1px] border-gray-400 ">
                            ...
                            <div class="flex gap-2 md:gap-4">
                                <a href={project.liveUrl} target="_blank" class="flex w-8 h-8 sm:w-12 sm:h-12 justify-center items-center bg-white shadow-lg p-1 sm:p-3 rounded-[5px] ">
                                ...
                                {#if project.codeUrl != "private"}
                                    <a href={project.codeUrl} target="_blank" class="flex w-8 h-8 sm:w-12 sm:h-12 justify-center items-center bg-black shadow-lg p-1 sm:p-3 rounded-[5px]">
                            ...
                            <a href={`/projects/${project.slug}`} class="block w-full">
                                <Button class="bg-black flex-1 w-full min-w-full block text-white font-title font-semibold text-xl rounded-[5px] shadow-[#00000066] active:bg-black hover:bg-black hover:brightness-90 active:scale-95 transition-all ">Discover More</Button>
                            </a>
                        </div>
                    </Carousel.Item>
                {/each}
