...
<section id="projects" class="col-span-2 bg-c-primary border-4 border-c-secondary py-12 pb-10 xs:px-6 sm:px-8 rounded-3xl shadow-claymorphism bg-test2" >
    ...
    >
                ...
                {#each projects as project (project.id)}
                    <Carousel.Item class="basis-[92%] lg:basis-1/2 flex flex-col gap-5">
                        ...
                        <div class="flex flex-wrap justify-between gap-y-6 px-6 py-4 rounded-xl bg-c-background border-[1px] border-gray-400 shadow-claymorphism-noshadow ">
                            <hgroup class="">
                                <h3 class="uppercase font-title text-c-body-text font-bold text-xl xs:text-2xl">{project.title.pt}</h3>
                                <p class="text-c-secondary text-xs">website</p>
                            </hgroup>
                            <div class="flex gap-4">
                                <a href="" target="_blank" class="flex w-12 h-12 justify-center items-center bg-c-tertiary p-3 rounded-xl shadow-claymorphism-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M352 256c0 22.2-1.2 43.6-3.3 64H163.3c-2.2-20.4-3.3-41.8-3.3-64s1.2-43.6 3.3-64H348.7c2.2 20.4 3.3 41.8 3.3 64zm28.8-64H503.9c5.3 20.5 8.1 41.9 8.1 64s-2.8 43.5-8.1 64H380.8c2.1-20.6 3.2-42 3.2-64s-1.1-43.4-3.2-64zm112.6-32H376.7c-10-63.9-29.8-117.4-55.3-151.6c78.3 20.7 142 77.5 171.9 151.6zm-149.1 0H167.7c6.1-36.4 15.5-68.6 27-94.7c10.5-23.6 22.2-40.7 33.5-51.5C239.4 3.2 248.7 0 256 0s16.6 3.2 27.8 13.8c11.3 10.8 23 27.9 33.5 51.5c11.6 26 20.9 58.2 27 94.7zm-209 0H18.6C48.6 85.9 112.2 29.1 190.6 8.4C165.1 42.6 145.3 96.1 135.3 160zM8.1 192H131.2c-2.1 20.6-3.2 42-3.2 64s1.1 43.4 3.2 64H8.1C2.8 299.5 0 278.1 0 256s2.8-43.5 8.1-64zM194.7 446.6c-11.6-26-20.9-58.2-27-94.6H344.3c-6.1 36.4-15.5 68.6-27 94.6c-10.5 23.6-22.2 40.7-33.5 51.5C272.6 508.8 263.3 512 256 512s-16.6-3.2-27.8-13.8c-11.3-10.8-23-27.9-33.5-51.5zM135.3 352c10 63.9 29.8 117.4 55.3 151.6C112.2 482.9 48.6 426.1 18.6 352H135.3zm358.1 0c-30 74.1-93.6 130.9-171.9 151.6c25.5-34.2 45.2-87.7 55.3-151.6H493.4z"/></svg>
                                </a>
                                <a href="" target="_blank" class="flex w-12 h-12 justify-center items-center bg-c-primary p-3 rounded-xl shadow-claymorphism-2">
                            ...
                            <a href="/projects/teste" class="block w-full">
                                <Button class="bg-gradient-to-b from-c-tertiary to-[#B5F186] flex-1 w-full min-w-full block text-c-darker-background font-title font-semibold text-xl rounded-xl text-shadow shadow-[#00000066] active:bg-c-tertiary hover:bg-c-tertiary hover:brightness-90 active:scale-95 transition-all shadow-claymorphism-2">Discover More</Button>
                            </a>
                        </div>
                    </Carousel.Item>
                {/each}
        ...
        <footer class=" p-2 mt-6 flex items-center justify-center gap-4 max-xs:px-4">
            ...
            {#each projects as project (project.id)}
                    <button on:click={() => api.scrollTo(project.id)} class="w-4 h-4 border-2 border-green-50 transition-all duration-300 rounded-full {current == project.id +1 ? ' relative rotate-45 bg-gray-50' : ''}"></button>
                {/each}
            </div>
