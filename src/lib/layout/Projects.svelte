            ...
            <Carousel.Item class="basis-[92%] lg:basis-1/2 flex flex-col gap-5">
                ...
                <div class="flex flex-wrap justify-between gap-y-6 px-6 py-4 rounded-xl bg-c-background border-[1px] border-gray-400 shadow-claymorphism-noshadow ">
                    ...
                    <div class="flex gap-4">
                        <a href="" target="_blank" class="flex justify-center items-center bg-c-tertiary p-3 rounded-xl shadow-claymorphism-2">
                        ...
                        <a href="" target="_blank" class="flex justify-center items-center bg-c-primary p-3 rounded-xl shadow-claymorphism-2">
